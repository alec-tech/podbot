...
1:30–4:30   Business Block (2 stories, Chuck leads)
4:30–7:30   Crossover Segment (rotating guest joins)
7:30–10:30  Tech Block (2 stories, Jessica leads)
10:30–11:00 Pre-Outro Sponsor (optional)
11:00–12:00 Wrap + Signoff
```

**Hosts:** Chuck Leblanc (business) and Jessica Waverly (tech) anchor every episode, joined by one rotating crossover guest: Drew Vasquez (geopolitics), Priya Nair (AI/deep tech), Marcus Cole (policy), Sam Torres (startups), or Jordan Blake (consumer/culture).
...
|------|------|-----------------|
| **Chuck Leblanc** | Business anchor | Authoritative, measured, confident |
| **Jessica Waverly** | Tech correspondent | Warm, energetic, conversational |
...
response = client.tts.generate(
    model_id="sonic-3",
    transcript="Welcome to The Signal morning edition. I'm Chuck Leblanc.",
